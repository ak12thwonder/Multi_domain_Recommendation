...
def evaluate_book_mf():
    ...
    user_item_matrix = train.pivot_table(index='User-ID', columns='book_id', values='Rating').fillna(0)
    ...
    save_accuracy_to_db('book_mf', round(precision_at_5, 4), total_users, round(recall_at_5, 4), round(f1_at_5, 4), round(mae, 4))
    return pd.DataFrame({
        "Model": ["Book Matrix Factorization"],

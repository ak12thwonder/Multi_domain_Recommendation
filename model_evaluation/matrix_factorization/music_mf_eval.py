...
def evaluate_music_mf():
    ...
    user_item_matrix = train.pivot_table(index='user_id', columns='artist_id', values='weight').fillna(0)
    ...
    save_accuracy_to_db('music_mf', round(precision_at_5, 4), total_users, round(recall_at_5, 4), round(f1_at_5, 4), round(mae, 4))
    return pd.DataFrame({
        "Model": ["Music Matrix Factorization"],
